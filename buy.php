    ...
    <section class="shop container">
        <div class="buy-item-container">
            ...
            <div class="address-box">
                <form method="post">
                    <textarea name="address" cols="145" rows="5" placeholder="Address" required></textarea>
                    <div class="transaction-type">
                        <p>Transaction Type</p>
                        <div class="user-type">
                            <div>
                                <input type="radio" class="radio-btn" name="transaction-type" value="credit-card" required>
                                <label for="credit-card">Credit Card</label>
                            </div>
                            <div>
                                <input type="radio" class="radio-btn" name="transaction-type" value="wire-transfer" required>
                                <label for="credit-card">Wire Transfer</label>
                            </div>
                        </div>
                    </div>
                    <input type="submit" name="btn-buy" class="btn-buy" value="Buy">
                </form>
            </div>
        </div>
    </section>
